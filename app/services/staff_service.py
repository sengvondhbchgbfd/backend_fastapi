...
from app.repositories.staff_repository import StaffRepository, StaffRolesRepository
from app.repositories.user_respo import UserRepository
...
class StaffService:
    ...
    async def create(
        ...
        if avatar_file and avatar_file.filename:
            ...
            upload_result = await upload_image(avatar_file, folder=folder)
    ...
    avatar_file: Optional[UploadFile] = None
        ...
        if avatar_file and avatar_file.filename:
            ...
            if existing.avatar_public_id:
                try:
                    result = await delete_asset(existing.avatar_public_id, resource_type="image")
