...
from app.repositories.auth.refresh_token_repository import RefreshTokenRepo
...
class AuthService:
    ...
    # =========================================================================
    # REFRESH — ✅ fully fixed verify
    # =========================================================================

    async def refresh(self, refresh_token: str) -> dict:
       
        user_id, company_id = decode_refresh_token(refresh_token)
    ...
    async def logout(self, user_id: int, company_id: int, client_ip: str) -> dict:
        ...
        await self.refresh_repo.revoke_all(user_id)
