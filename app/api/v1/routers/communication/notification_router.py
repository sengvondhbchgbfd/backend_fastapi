...
from app.schemas.schema import (NotificationCreate,NotificationResponse,NotificationSummaryResponse,BulkMarkReadRequest)
...
@notification_router.get("/my", response_model=list[NotificationResponse], summary="Get my notifications")
...
# ✅ 4. dynamic {notification_id} routes LAST
@notification_router.patch("/my/{notification_id}/read", response_model=NotificationResponse, summary="Mark one notification as read")
...
# ✅ 2. static PATCH routes before /{notification_id}
@notification_router.patch("/my/read-all", summary="Mark all my notifications as read")
...
@notification_router.get("/", response_model=list[NotificationResponse], summary="[Admin] List all company notifications")
...
@notification_router.post("/", response_model=NotificationResponse, status_code=status.HTTP_201_CREATED, summary="[Admin] Send notification to a user")
