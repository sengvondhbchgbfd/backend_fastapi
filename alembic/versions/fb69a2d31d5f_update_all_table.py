...
Revision ID: fb69a2d31d5f
Revises: 
Create Date: 2026-05-07 11:35:02.159112
...
def upgrade() -> None:
    ...
    sa.Column('logo_public_id', sa.Text(), nullable=True),
    sa.Column('banner_url', sa.Text(), nullable=True),
    sa.Column('banner_public_id', sa.Text(), nullable=True),
    ...
    sa.Column('company_id', sa.Integer(), nullable=False),
    sa.Column('old_status', sa.Enum('active', 'suspended', 'cancelled', name='companystatus'), nullable=False),
    sa.Column('new_status', sa.Enum('active', 'suspended', 'cancelled', name='companystatus'), nullable=False),
    ...
    sa.UniqueConstraint('company_id', 'role_name', name='uq_roles_company_role')
    )
    ...
    sa.Column('chat_type', sa.Enum('group', 'direct', name='chattype'), nullable=False),
    ...
    sa.Column('message_type', sa.Enum('text', 'image', 'file', 'audio', 'video', 'voice', name='messagetype'), nullable=False),
    sa.Column('content', sa.Text(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=False),
    sa.Column('file_url', sa.String(length=500), nullable=True),
    sa.Column('publice', sa.String(length=500), nullable=True),
    ...
    sa.ForeignKeyConstraint(['reply_to_id'], ['chat_messages.message_id'], ),
